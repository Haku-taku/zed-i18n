<div align="center">
  ...
  [![Zed v1.20.2](https://img.shields.io/badge/Zed-v1.20.2-blue?logo=zedindustries&logoColor=white)](https://github.com/zed-industries/zed/releases/tag/v1.20.2)
...
В Linux и Windows при самостоятельной настройке сочетаний клавиш для меню приложения (`app_menu::OpenApplicationMenu`) можно использовать постоянные английские названия меню, например `File`, `Edit` и `View`. Благодаря этому сочетания клавиш продолжат работать даже после смены языка интерфейса. Примеры приведены в документе [Настройка сочетаний клавиш для меню приложения (на английском)](../menu-access-keys.md).
