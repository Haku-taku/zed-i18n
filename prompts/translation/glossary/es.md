...
|---------|---------|-------------|
| Account | | Cuenta |
| Action | Zed/GPUI / code action | Acción |
| Action | actual operation / task | Operación |
| Agent | AI agent feature | Agente |
...
| Completion Tokens | LLM token budget (max_completion_tokens) | Tokens de generación |
| Context | | Contexto |
| Cursor | | Cursor |
| Debug | | Depurar |
| Definition | code navigation | Definición |
...
| Filter | | Filtrar |
| Folder | | Carpeta |
| Hunk | diff hunk | Fragmento |
| Inline | | Insertado |
| Issue | GitHub / project tracker | Incidencia |
| Issue | diagnostics / generic | Problema |
...
| Model | | Modelo |
| Outline | | Esquema |
| Pane | split editor pane | Panel dividido |
...
| Subagent | | Subagente |
| Suggestion | inline / AI suggestion | Sugerencia |
| Symbol | | Símbolo |
| Tag | | Etiqueta |
| Terminal | | Terminal |
| Thread | AI conversation | Conversación |
| Thread | OS/programming thread | Subproceso |
| Title Bar | | Barra de título |
| Tool | | Herramienta |
| Tool Call | | Llamada de herramienta |
| Tooltip | Hover popup, including project-panel title tooltip settings; not inline/inlay hints or a static label | descripción emergente |
...
| Watch Roots | Watcher diagnostics tab for registered root paths; inflect naturally in its description and empty state | Raíces de vigilancia |
| Watcher events | Filesystem change notifications in watcher diagnostics; not debugger variable watches | eventos de vigilancia |
| Window | | Ventana |
