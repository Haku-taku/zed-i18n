...
| Action | Zed/GPUI / code action | Действие |
| Action | generic operation / task | Операция |
| Agent | AI agent feature | Агент |
| Authentication | | Аутентификация |
| Branch | | Ветка |
| Breadcrumbs | | Элементы навигации |
| Breakpoint | | Точка останова |
| Call | voice / collaboration | Звонок |
| Call | tool / function / API | Вызов |
| Call Hierarchy | Code navigation through callers and callees; not voice calls or the debugger call stack | иерархия вызовов |
| Chat | | Чат |
| Chevron | FolderIndicator setting option for the folder expand/collapse marker; keep related disclosure-chevron descriptions consistent | Стрелка |
| Command Palette | | Палитра команд |
| Commit | | Коммит |
| Completion | editor autocomplete | Автозавершение |
| Completion Tokens | LLM token budget (max_completion_tokens) | Токены завершения |
| Context | | Контекст |
| Cursor | | Курсор |
| Debug | | Отладка |
| Definition | code navigation | Определение |
...
| Filter | | Фильтр |
| Folder | | Папка |
| Hunk | diff hunk | Блок изменений |
| Inline | | Встроенный |
| Issue | GitHub / project tracker | Задача |
| Issue | diagnostics / generic | Проблема |
...
| Model | | Модель |
| Outline | | Структура |
| Pane | split editor pane | Область |
| Panel | named Zed panel | Панель |
| Patch | | Исправление |
| Path | | Путь |
| Permalink | Git hosting link pinned to a specific commit, file, line, or selection | постоянная ссылка |
...
| Session | | Сеанс |
| Settings | | Параметры |
| Shallow Clone | Git clone with truncated commit history; distinct from partial clone object filtering | поверхностное клонирование |
| Sign In | | Войти |
| Sign Out | | Выйти |
| Skill | Agent Skills feature | Навык |
| Snapshot | Git commit view: full file contents at that commit displayed as added; not a restore action | снимок |
| Snippet | | Фрагмент |
...
| Subagent | | Вложенный агент |
| Suggestion | inline / AI suggestion | Предложение |
| Symbol | | Символ |
| Tag | | Тег |
| Terminal | | Терминал |
| Thread | AI conversation | Цепочка |
| Thread | OS/programming thread | Поток |
