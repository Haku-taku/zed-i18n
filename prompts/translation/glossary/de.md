...
|---------|---------|-------------|
| Account | | Konto |
| Action | Zed/GPUI / code action | Aktion |
| Action | generic operation / task | Vorgang |
| Agent | AI agent feature | Agent |
| Authentication | | Authentifizierung |
| Branch | | Branch |
| Breadcrumbs | | Breadcrumbs |
| Breakpoint | | Haltepunkt |
| Call | voice / collaboration | Anruf |
| Call | tool / function / API | Aufruf |
| Call Hierarchy | Code navigation through callers and callees; not voice calls or the debugger call stack | Aufrufhierarchie |
| Chat | | Chat |
| Chevron | FolderIndicator setting option for the folder expand/collapse marker; keep related disclosure-chevron descriptions consistent | Aufklapppfeil |
| Command Palette | | Befehlspalette |
| Commit | | Commit |
| Completion | editor autocomplete | Vervollständigung |
| Completion Tokens | LLM token budget (max_completion_tokens) | Antwort-Token |
| Context | | Kontext |
| Cursor | | Cursor |
| Debug | | Debuggen |
...
| Model | | Modell |
| Outline | | Gliederung |
| Pane | split editor pane | Bereich |
...
| Prompt | user text-input prompt (enter a value) | Eingabeaufforderung |
...
| Shallow Clone | Git clone with truncated commit history; distinct from partial clone object filtering | Shallow Clone |
| Sign In | | Anmelden |
| Sign Out | | Abmelden |
...
| Subagent | | Unteragent |
| Suggestion | inline / AI suggestion | Vorschlag |
| Symbol | | Symbol |
| Tag | | Tag |
| Terminal | | Terminal |
| Thread | | Thread |
