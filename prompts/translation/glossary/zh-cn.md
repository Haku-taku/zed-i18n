...
| Cursor | | 光标 |
| Debug | | 调试 |
| Definition | code navigation | 定义 |
| Diagnostics | | 诊断 |
| Diff | | 差异 |
| Editor | | 编辑器 |
| Extension | software / plugin | 扩展 |
| Extension | file name suffix | 文件扩展名 |
| Fetch | Git remote operation | 抓取 |
| Fetch | data / network / completion retrieval | 获取 |
| File | | 文件 |
| Filter | | 筛选器 |
| Folder | | 文件夹 |
| Hunk | diff hunk | 区块 |
| Inline | | 内联 |
| Issue | GitHub / project tracker | 议题 |
| Issue | diagnostics / generic | 问题 |
| Keybinding | | 键绑定 |
...
| Tag | | 标签 |
| Terminal | | 终端 |
| Thread | AI conversation | 会话 |
| Thread | OS/programming thread | 线程 |
| Title Bar | | 标题栏 |
| Tool | | 工具 |
| Tool Call | | 工具调用 |
...
| Watch Roots | Watcher diagnostics tab for registered root paths; inflect naturally in its description and empty state | 监视根目录 |
| Watcher events | Filesystem change notifications in watcher diagnostics; not debugger variable watches | 监视器事件 |
| Window | | 窗口 |
| Workspace | | 工作区 |
| Worktree | | 工作树 |
