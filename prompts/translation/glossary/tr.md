...
|---------|---------|-------------|
| Account | | Hesap |
| Action | Zed/GPUI / code action | Eylem |
| Action | generic operation | İşlem |
| Agent | AI agent feature | Aracı |
...
| Completion Tokens | LLM token budget (max_completion_tokens) | Yanıt belirteci |
| Context | | Bağlam |
| Cursor | | İmleç |
| Debug | | Hata ayıklama |
| Definition | code navigation | Tanım |
...
| Filter | | Filtre |
| Folder | | Klasör |
| Hunk | diff hunk | Değişiklik bloğu |
| Inline | | Satır içi |
| Issue | | Sorun |
...
| Tag | | Etiket |
| Terminal | | Terminal |
| Thread | AI conversation | Konuşma |
| Thread | OS/programming thread | İş parçacığı |
