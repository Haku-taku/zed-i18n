...
|---------|---------|-------------|
| Account | | Account |
| Action | Zed/GPUI / code action | Azione |
| Action | generic operation / task | Operazione |
...
| Completion Tokens | LLM token budget (max_completion_tokens) | Token di risposta |
| Context | | Contesto |
| Cursor | | Cursore |
| Debug | | Debug |
| Definition | code navigation | Definizione |
...
| Prompt | OS / system dialog (file picker, confirmation) | Finestra di dialogo |
| Prompt | user text-input prompt (enter a value) | Prompt di input |
...
| Subagent | | Agente secondario |
| Suggestion | inline / AI suggestion | Suggerimento |
| Symbol | | Simbolo |
| Tag | | Tag |
| Terminal | | Terminale |
| Thread | AI conversation | Conversazione |
