...
|---------|---------|-------------|
| Account | | Conta |
| Action | Zed/GPUI / code action | Ação |
| Action | actual operation / task | Operação |
...
| Completion Tokens | LLM token budget (max_completion_tokens) | tokens de resposta |
| Context | | Contexto |
| Cursor | | Cursor |
| Debug | | Depuração |
| Definition | code navigation | Definição |
...
| Pane | split editor pane | Subpainel |
...
| Subagent | | Subagente |
| Suggestion | inline / AI suggestion | Sugestão |
| Symbol | | Símbolo |
| Tag | | Tag |
| Task | background task / task runner | Tarefa |
| Terminal | | Terminal |
| Thread | AI conversation | Conversa |
